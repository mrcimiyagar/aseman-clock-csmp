...
import csmp.helpers.DatabaseHelper;
import csmp.helpers.JsonHelper;
...
public class NetworkHelper {
    ...
    //public static String SERVER_IP = "http://localhost:8080/";
    public static String SERVER_IP = "http://188.40.173.232:8080/";
    ...
    public static void setup() {
        ...
        builder.addInterceptor(chain -> {
            ...
            csmp.helpers.LogHelper.log("OkHttp", log);
            log = "";
