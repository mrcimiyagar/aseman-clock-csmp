...
import csmp.rxbus.AbstractSubscriber;

import java.lang.reflect.Method;

class AnnotatedSubscriber<T> extends csmp.rxbus.AbstractSubscriber<T> {
    ...
    AnnotatedSubscriber(Object observer, Method method) {
