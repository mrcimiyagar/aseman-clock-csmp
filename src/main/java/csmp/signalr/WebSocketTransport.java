...
class WebSocketTransport implements csmp.signalr.Transport {
    private csmp.signalr.WebSocketWrapper webSocketClient;
    ...
    public WebSocketTransport(Map<String, String> headers, csmp.signalr.HttpClient client) {
        this.client = client;
