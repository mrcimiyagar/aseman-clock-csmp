...
class OkHttpWebSocketWrapper extends csmp.signalr.WebSocketWrapper {
    private WebSocket websocketClient;
    private String url;
    private Map<String, String> headers;
    private OkHttpClient client;
    private csmp.signalr.OnReceiveCallBack onReceive;
    ...
    @Override
    public void setOnReceive(csmp.signalr.OnReceiveCallBack onReceive) {
