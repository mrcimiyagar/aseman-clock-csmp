...
import csmp.signalr.HttpResponse;
import csmp.signalr.WebSocketWrapper;

final class DefaultHttpClient extends csmp.signalr.HttpClient {
    ...
    @Override
    public Single<csmp.signalr.HttpResponse> send(csmp.signalr.HttpRequest httpRequest) {
        return send(httpRequest, null);
    }

    @Override
    public Single<csmp.signalr.HttpResponse> send(csmp.signalr.HttpRequest httpRequest, String bodyContent) {
        ...
        SingleSubject<csmp.signalr.HttpResponse> responseSubject = SingleSubject.create();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try (ResponseBody body = response.body()) {
                    csmp.signalr.HttpResponse httpResponse = new csmp.signalr.HttpResponse(response.code(), response.message(), body.string());
    ...
    @Override
    public csmp.signalr.WebSocketWrapper createWebSocket(String url, Map<String, String> headers) {
