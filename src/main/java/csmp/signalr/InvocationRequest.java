...
import csmp.signalr.CompletionMessage;
import csmp.signalr.HubException;
...
class InvocationRequest {
    ...
    public void complete(csmp.signalr.CompletionMessage completion) {
    ...
    public void addItem(csmp.signalr.StreamItem streamItem) {
